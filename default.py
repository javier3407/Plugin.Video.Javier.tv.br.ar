# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Javier TV - Kodi Addon by Javier (junalerio@gmail.com)
...
def main_list(params):
    ...
    try:
        ...
        mastermenu = 'https://dl.dropboxusercontent.com/u/8036850/JavierTV/JavierTV-0.3.1.xml'
        data = plugintools.read(mastermenu)
